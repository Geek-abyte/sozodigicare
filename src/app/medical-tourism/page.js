      ...
      <div className="container mx-auto px-8 py-12">
        ...
        <section className="mb-20">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white p-8 shadow-lg">
              <p className="text-lg">
                Medical tourism opens doors to advanced treatments abroad, often
                at a fraction of the cost. With globally accredited hospitals
                and cutting-edge technology, you can combine top-tier healthcare
                with the opportunity to recover in serene, exotic locations.
              </p>
            </div>
          </div>
        </section>
            ...
            {[
              {
                ...
                description: "Save up to 80% on procedures",
              },
              {
                icon: <FaUserMd />,
                title: "Expert Doctors",
                description: "Access to world-class specialists",
              },
              {
                icon: <FaCalendarAlt />,
                title: "No Wait Times",
                description: "Immediate treatment availability",
              },
              {
                icon: <FaHandHoldingMedical />,
                title: "Personalized Care",
                description: "Tailored medical experiences",
              },
              {
                icon: <FaGlobe />,
                title: "Travel & Heal",
                description: "Combine treatment with tourism",
              },
            ].map((benefit, index) => (
              <div
                key={index}
                className="w-1/2 md:w-1/5 p-4 text-center flex flex-col justify-center items-center"
              >
        ...
        <section className="mb-20">
          ...
          <p className="text-xl text-center mb-8">
            We cater to a wide range of medical procedures and treatments, with
                ...
                <motion.header
                  ...
                  onClick={() =>
                    setExpandedSpecialty(
                      expandedSpecialty === index ? null : index,
                    )
                  }
                >
          ...
          <div className="relative">
            ...
            <div className="relative bg-white p-8 shadow-lg">
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  24/7 support from dedicated medical tourism professionals
                </li>
                <li>
                  Partnerships with only accredited hospitals and certified
                  doctors
                </li>
            ...
            {[
              {
                ...
                location: "Thailand",
                quote:
                  "SozoDigiCare made my entire medical tourism journey smooth and stress-free. From coordinating my surgery in Thailand to arranging my accommodation, everything was perfectly handled.",
              },
              {
                ...
                location: "Mexico",
                quote:
                  "Thanks to the team, I received top-quality dental care in Mexico and saved thousands. I felt supported every step of the way.",
              },
              ...
              >
                <div className="p-6">
                  <div className="uppercase tracking-wide text-sm text-indigo-500 font-semibold mb-2">
                    {testimonial.procedure} in {testimonial.location}
                  </div>
        ...
        <section className="mb-20 bg-gradient-to-r from-blue-500 to-purple-600 text-white py-16 rounded-lg shadow-xl">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              ...
              your medical tourism experience. From choosing the right treatment
              to planning your travel, we've got you covered.
            </p>
