            ...
            <div className="md:w-1/2 bg-[var(--color-primary-6)] p-6 text-white">
              ...
              <form>
                <div className="mb-4">
                  ...
                  <input type="text" id="name" className="w-full px-3 py-2 text-gray-700 bg-gray-200 rounded" />
                </div>
                <div className="mb-4">
                  <label className="block mb-2" htmlFor="email">Email</label>
                  <input type="email" id="email" className="w-full px-3 py-2 text-gray-700 bg-gray-200 rounded" />
                </div>
                <div className="mb-4">
                  <label className="block mb-2" htmlFor="message">Message</label>
                  <textarea id="message" rows="4" className="w-full px-3 py-2 text-gray-700 bg-gray-200 rounded"></textarea>
                </div>
                <button type="submit" className="bg-white text-[var(--color-primary-6)] font-bold py-2 px-4 rounded hover:bg-gray-100 transition duration-300">
                  Send Message
                </button>
              </form>
            </div>
