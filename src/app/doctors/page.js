        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl opacity-90 mb-8">
              Our network of qualified medical specialists are ready to provide
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center text-gray-600 text-sm mb-2">
                    ...
                    <span>
                      {doctor.qualifications || "Medical Professional"}
                    </span>
                  </div>
                  ...
                  <div className="flex-1">
                    <div className="flex flex-wrap justify-between items-start mb-2">
                      <div>
                        ...
                        <p className="text-[var(--color-primary-6)] font-medium">
                          {doctor.category}
                        </p>
                      </div>
                    ...
                    <p className="text-gray-600 text-sm mb-4 line-clamp-2">
                      {doctor.bio ||
                        "Experienced healthcare professional dedicated to providing quality care to patients."}
                    </p>
              ...
              <div className="flex flex-col md:flex-row rounded-3xl overflow-hidden">
                <div className="md:w-1/3 bg-gradient-to-br from-[var(--color-primary-7)] to-[var(--color-primary-5)] p-8 text-white">
                  <div className="mb-6 flex flex-col items-center">
                    ...
                    <p className="text-[var(--color-primary-1)] font-medium">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-sm uppercase tracking-wider text-[var(--color-primary-1)] font-semibold mb-1">
                        Specialization
                      </h3>
                ...
                <div className="md:w-2/3 p-8">
                    ...
                    <ul className="list-disc list-inside text-gray-600 space-y-1">
                      {selectedDoctor.services
                        ...
                        : [
                            ...
                            "Follow-up Care",
                          ].map((service, idx) => <li key={idx}>{service}</li>)}
                    </ul>
                  </div>
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-gray-600 mb-2">
                      Dr. {selectedDoctor.lastName} is available for
                      appointments. Book now to secure your preferred time slot.
                    </p>
                  </div>
