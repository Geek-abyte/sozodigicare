  ...
  const services = [
    {
      ...
      description:
        "Utilize our advanced self-assessment tools to quickly and accurately identify possible health concerns based on your symptoms, helping you make informed decisions about your next steps.",
    ...
    {
      icon: (
        <FaPlaneDeparture className="text-5xl text-[var(--color-primary-6)]" />
      ),
      title: "Medical Tourism",
      description:
        "Access international healthcare opportunities with assistance in finding top medical facilities abroad, booking appointments, and arranging travel for specialized treatments.",
      animation: "M20 20 Q50 80 80 20",
      link: "/medical-tourism",
    },
    {
      icon: (
        <FaPrescriptionBottleAlt className="text-5xl text-[var(--color-primary-6)]" />
      ),
      title: "Pharmacy Referral",
      description:
        "Get prescriptions fulfilled quickly by connecting with trusted partner pharmacies near you or opt for doorstep delivery, ensuring timely access to your medications.",
    ...
    },
    {
      ...
      description:
        "Receive lab test referrals and connect with accredited laboratories for diagnostics, ensuring accurate results and seamless follow-up with your healthcare provider.",
          ...
          <div className="relative max-w-6xl mx-auto z-10">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-12">
              ...
              <div className="flex flex-col items-center text-center w-full md:w-1/3 relative z-10">
                ...
                <h3 className="text-xl text-gray-600 font-semibold mt-4">
                  Click consult a doctor
                </h3>
                <p className="text-gray-600 mt-2">
                  Click to consult a doctor and receive your appointment
                  confirmation.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center w-full md:w-1/3 relative z-10">
                ...
                <p className="text-gray-600 mt-2">
                  Meet with the doctor at your scheduled time.
                </p>
              </div>
            </div>
          </div>
